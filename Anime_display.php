...
<head>
	<?php 
		...
		$query = "SELECT name FROM anime WHERE anime_id = $anime_id";
		$result = mysqli_query($con,$query);
		while ($row = mysqli_fetch_array($result)) {
			# code...
		
	?>
	<title>Watch Anime <?=$row['name']?></title>
<?php } ?>
    ...
    <li class="u-nav-item">
      <a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" style="padding: 10px 25px;" href="Popular.php">Popular
        ...
        <!--END OF NAVBAR --></header> 
      	<div class="container-fluid" style="background-color: grey;padding: 150px;padding-left: 100px;">
      		<?php 
      				require_once "Dbconnect.php";
      				$anime_id = $_GET['anime_id']; 
                    ...
                    while ($row = mysqli_fetch_array($rs_result)) {
                      # code...
               ?>
      		<img src="<?=$row['image']?>" alt="<?=$row['image']?>" style = "width: 400px;height: 600px;border-radius: 20px">
      		<div style="float: left;">
      			<div class="container" style="padding: 20px;">
      				<h3 style="color: black;position: absolute;margin-left: 450px;font-family: fantasy;">"<?=$row['name']?>"</h3>
      				<br><br><br><br>
      				<h5 style="color: black;position: absolute;margin-left: 450px;font-family: monospace;"><?=$row['description']?></h5>
      				<br><br><br><br><br><br><br><br><br><br>
      				<h5 style="color: black;position: absolute;margin-left: 450px;font-family: monospace;">Genre: <?=$row['genre']?></h5>
      				<br>
      				<h5 style="color: black;position: absolute;margin-left: 450px;font-family: monospace;">Type: <?=$row['type']?></h5>
      				<br>
      				<h5 style="color: black;position: absolute;margin-left: 450px;font-family: monospace;">Episodes: <?=$row['episodes']?></h5>
      				<br>
      				<h5 style="color: black;position: absolute;margin-left: 450px;font-family: monospace;">Rating: <?=$row['rating']?></h5>
      				<br>
      				<h5 style="color: black;position: absolute;margin-left: 450px;font-family: monospace;">Members: <?=$row['members']?></h5>
      				<br><br><br>
      				<a href="https://www.youtube.com/results?search_query=<?=$row['name']?>"><button style="position: absolute;margin-left: 450px;" type="button" class="btn btn-danger btn-lg">Watch Now!</button></a>
      			</div>
      	<?php } ?>
      	</div>
      </div>
